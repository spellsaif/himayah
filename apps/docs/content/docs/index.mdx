...
<p align="center">
  <img src="/logo.png" alt="Himayah Logo" width="180" style={{ borderRadius: '20px', boxShadow: '0 10px 40px rgba(0,0,0,0.4)', marginBottom: '2rem', display: 'block', marginLeft: 'auto', marginRight: 'auto' }} />
</p>
